package com.planesnet.android.sbd.log;
...
public class SendLogActivity extends Activity {
    ...
    public static final String ACTION_SEND_LOG = "com.planesnet.android.sbd.SEND_LOG";//$NON-NLS-1$
    public static final String EXTRA_SEND_INTENT_ACTION = "com.planesnet.android.sbd.SEND_INTENT_ACTION";//$NON-NLS-1$
    public static final String EXTRA_DATA = "com.planesnet.android.sbd.DATA";//$NON-NLS-1$
    public static final String EXTRA_ADDITIONAL_INFO = "com.planesnet.android.sbd.ADDITIONAL_INFO";//$NON-NLS-1$
    public static final String EXTRA_SHOW_UI = "com.planesnet.android.sbd.SHOW_UI";//$NON-NLS-1$
    public static final String EXTRA_FILTER_SPECS = "com.planesnet.android.sbd.FILTER_SPECS";//$NON-NLS-1$
    public static final String EXTRA_FORMAT = "com.planesnet.android.sbd.FORMAT";//$NON-NLS-1$
    public static final String EXTRA_BUFFER = "com.planesnet.android.sbd.BUFFER";//$NON-NLS-1$
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (null == mSendIntent) {
            ...
            mSendIntent.putExtra(Intent.EXTRA_SUBJECT, "Send Log");
            mSendIntent.setType("text/plain");//$NON-NLS-1$
    ...
    private class CollectLogTask extends AsyncTask<ArrayList<String>, Void, StringBuilder> {
        ...
        protected StringBuilder doInBackground(ArrayList<String>... params) {
            ...
            try {
                ...
                commandLine.add("| tail -n 1000");//$NON-NLS-1$
